...
class SimpleConsulServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Registration is idempotent — calling it on every boot just refreshes
        // the service entry. Consul's health check + DeregisterCriticalServiceAfter
        // handles removal when the app goes down (no need to deregister on terminate).
